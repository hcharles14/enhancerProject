...
, '12_EnhBiv', '13_ReprPC', '14_ReprPCWk', '15_Quies'),multiple=TRUE)
  ...
  fluidRow(column(3,offset=6,conditionalPanel(condition="$('html').hasClass('shiny-busy')",
                 tags$div("Processing...",id="process_message")))),
  fluidRow(column(3,offset=6,conditionalPanel(condition="!$('html').hasClass('shiny-busy')",downloadButton('downloadData', 'Download'))))       
),
